...
### This script was wrote to use picard.jar downloaded in "~/Desktop/program/picard" folder.
...
for f in *.sort.bam; do
  ...
  java -jar ~/Desktop/program/picard/picard.jar CollectInsertSizeMetrics \
