...
multiBigwigSummary bins -b $bigwig_files -o ~/Desktop/GSE126612/correlation-comparison/bigwig_summary_bs1000.npz -p 12 -bs 1000
...
plotCorrelation -in bigwig_summary_bs1000.npz -c pearson -p heatmap -o plot_pearson_bigwig_summary_bs1000.pdf -T "SRPMC normalized, bin 1000, pearson" \
    --colorMap bwr --skipZeros --removeOutliers -min 0 -max 1 --plotNumbers --plotHeight 28.5 --plotWidth 33
...
plotPCA -in bigwig_summary_bs1000.npz -o plot_PCA_bigwig_summary_bs1000.pdf -T "SRPMC normalized, bin 1000" \
    --ntop 10000 --transpose --plotHeight 30 --plotWidth 32.5
...
for bigwig_file in *_subtracted.bw; do
    bigwig_files="$bigwig_files $bigwig_file"
done
...
### Run multiBigwigSummary
multiBigwigSummary bins -b $bigwig_files -o ~/Desktop/GSE126612/correlation-comparison/subracted_bigwig_summary_bs500.npz -p 12 -bs 500
multiBigwigSummary bins -b $bigwig_files -o ~/Desktop/GSE126612/correlation-comparison/subracted_bigwig_summary_bs1000.npz -p 12 -bs 1000
multiBigwigSummary bins -b $bigwig_files -o ~/Desktop/GSE126612/correlation-comparison/subracted_bigwig_summary_bs5000.npz -p 12 -bs 5000
multiBigwigSummary bins -b $bigwig_files -o ~/Desktop/GSE126612/correlation-comparison/subracted_bigwig_summary_bs10000.npz -p 12 -bs 10000

### Setting the comparison folder as working directory
cd ~/Desktop/GSE126612/correlation-comparison

### Run plotCorrelation for bigwig_summary.npz
plotCorrelation -in subracted_bigwig_summary_bs500.npz -c pearson -p heatmap -o plot_pearson_bigwig_summary_subracted_bs500.pdf -T "SRPMC normalized, subtracted, bin 500, pearson" \
    --colorMap bwr --skipZeros --removeOutliers -min 0 -max 1 --plotNumbers --plotHeight 28.5 --plotWidth 33
plotCorrelation -in subracted_bigwig_summary_bs1000.npz -c pearson -p heatmap -o plot_pearson_bigwig_summary_subracted_bs1000.pdf -T "SRPMC normalized, subtracted, bin 1000, pearson" \
    --colorMap bwr --skipZeros --removeOutliers -min 0 -max 1 --plotNumbers --plotHeight 28.5 --plotWidth 33
plotCorrelation -in subracted_bigwig_summary_bs5000.npz -c pearson -p heatmap -o plot_pearson_bigwig_summary_subracted_bs5000.pdf -T "SRPMC normalized, subtracted, bin 5000, pearson" \
    --colorMap bwr --skipZeros --removeOutliers -min 0 -max 1 --plotNumbers --plotHeight 28.5 --plotWidth 33
plotCorrelation -in subracted_bigwig_summary_bs10000.npz -c pearson -p heatmap -o plot_pearson_bigwig_summary_subracted_bs10000.pdf -T "SRPMC normalized, subtracted, bin 10000, pearson" \
    --colorMap bwr --skipZeros --removeOutliers -min 0 -max 1 --plotNumbers --plotHeight 28.5 --plotWidth 33
...
plotPCA -in subtracted_bigwig_summary_bs500.npz -o plot_PCA_bigwig_summary_subtracted_bs500.pdf -T "SRPMC normalized, subtracted, bin 500" \
    --ntop 10000 --transpose --plotHeight 30 --plotWidth 32.5
plotPCA -in subtracted_bigwig_summary_bs1000.npz -o plot_PCA_bigwig_summary_subtracted_bs1000.pdf -T "SRPMC normalized, subtracted, bin 1000" \
    --ntop 10000 --transpose --plotHeight 30 --plotWidth 32.5
